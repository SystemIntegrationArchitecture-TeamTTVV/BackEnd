...
public class ProductController {
    ...
    public ResponseEntity<Page<ProductDto>> getAllProducts(
        ...
        Page<ProductDto> result = productService.getAllProducts(page, pageSize, category, search, sortBy, sortOrder);
    ...
    public ResponseEntity<Page<ProductDto>> getUserProducts(
        ...
        return ResponseEntity.ok(productService.getUserProducts(userId, page, pageSize));
    }
